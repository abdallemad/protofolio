        ...
        <div className="container mx-auto max-w-6xl">
          ...
          >
            <div className="flex-1 space-y-6">
              ...
              <h1 className="text-4xl md:text-6xl font-bold font-outfit tracking-tighter">
                {t.title.main} <span className="text-primary">{t.title.highlight}</span> {t.title.end}
              </h1>
              ...
              <div className="relative aspect-square rounded-2xl overflow-hidden border border-border/50 bg-muted/50 backdrop-blur-sm p-2 group">
                <div className="w-full h-full bg-gradient-to-br from-primary/20 via-background to-background rounded-xl flex items-center justify-center relative overflow-hidden">
                  ...
                  <div className="text-center p-8">
                    <h3 className="text-2xl font-bold mb-2">{t.card.title}</h3>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-24">
            ...
            >
              ...
              <h3 className="text-xl font-bold mb-3 font-outfit">{t.journey.technical.title}</h3>
              <p className="text-muted-foreground">
                {t.journey.technical.description}
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              ...
              <h3 className="text-xl font-bold mb-3 font-outfit">{t.journey.design.title}</h3>
              <p className="text-muted-foreground">
                {t.journey.design.description}
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              ...
              <h3 className="text-xl font-bold mb-3 font-outfit">{t.journey.performance.title}</h3>
              <p className="text-muted-foreground">
                {t.journey.performance.description}
              </p>
            </motion.div>
          </div>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="rounded-3xl bg-gradient-to-r from-primary/20 to-purple-500/20 p-px"
          >
            <div className="bg-background/90 backdrop-blur-xl rounded-3xl p-12 text-center">
              <h2 className="text-3xl font-bold mb-6 font-outfit">{t.cta.title}</h2>
              <p className="text-muted-foreground max-w-2xl mx-auto mb-8">
                {t.cta.description}
              </p>
              <Button size="lg" className="rounded-full text-base px-8 group">
                {t.cta.button} <ArrowRight className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform" />
              </Button>
            </div>
          </motion.div>
